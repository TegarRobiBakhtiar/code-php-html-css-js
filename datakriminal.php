...
<title>RSJTadinyaMesra | Data Tahanan</title>
...
<div class="wrapper">
	...
	<span class="brand-text font-weight-light">Lapas NusaKemambang</span>
	</a>
	<div class="sidebar">
		...
		<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
			...
			<li class="nav-item">
				...
				<p>
					 Kelola Tahanan <i class="fas fa-angle-left right"></i>
				</p>
				</a>
				<ul class="nav nav-treeview">
					...
					<li class="nav-item">
						<a href="edittahanan.php" class="nav-link">
						<i class="far fa-circle nav-icon"></i>
						<p>
							 Tambah Tahanan
						</p>
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Data Kriminal Indonesia</li>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="container-fluid">
            ...
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Data Kriminal 2023</h3>
	...
	<strong>Copyright &copy; 2023 <a href="#">Lapas NusaKemambang</a>.</strong> All rights reserved. </footer>
